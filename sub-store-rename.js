...
// prettier-ignore
const valueArray= [ "2×","3×","4×","5×","6×","7×","8×","9×","10×","20×","30×","40×","50×","IPLC","IEPL","Kern","Edge","Pro","Std","Exp","Biz","Fam","Game","Buy","DPLC","LB","CF","UDP","GPT","UDPN"];
...
const rurekey = {
  ...
  "Taiwan TW 台湾 🇹🇼": /(台湾|台灣|台|Tai\s?wan|TW)/g,
